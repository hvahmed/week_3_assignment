...
class OpenRouterEmbedder:
    ...
    def embed_query(self, text: str) -> np.ndarray:
        ...
        if response.status_code != 200:
            raise Exception(f"Error embedding query: {response.text}")
...
class RetrievalPipeline:
    ...
    def __init__(self, config: Optional[RetrievalPipelineConfig] = None):
        ...
        self.embedder = OpenRouterEmbedder(api_key=config.openrouter_api_key)
        print("Embedder initialized")

        with open(config.chunks_path, 'r',encoding='utf-8') as file:
            data = json.load(file)
   ...
   # For BM25 results
    ...
    def rerank(self, query: str, results: list[dict], top_k: int = 10) -> list[dict]:
        ...
        try:
            ...
            result["score"] = relevance_score  # Update main score with rerank score
    ...
    def retrieve(self, query: str, top_k: int = 8) -> list[RetrievalResult]:
        ...
        Args:
            ...
            top_k: Number of results to returnhttps://claude.ai/code
